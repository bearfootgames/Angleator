...
{
    /// <summary>
    /// Example UI panel to play .enfl animations, including features like speed control, looping, autoplay, and time scrubbing.
    /// This demonstrates the API and subscribing to the events of <see cref="EnfluxFilePlayer"/>.
    /// </summary>
    public class EnfluxFilePlayerPanel : MonoBehaviour
    {
        ...
        /// <summary>
        /// The type of location to load files from.
        /// </summary>
        ...
        {
            // TODO: Make sure fields aren't null!
...
#if UNITY_WEBGL
            _dataSource = DataSource.URL;
            _filenameInputField.text = _filenameInputField.text != "" ? "" : "https://cdn.shopify.com/s/files/1/1583/6483/files/6.enfl?3782952979307138752";
#else
        ...
        private void OpenFileButtonOnClick()
        {
            ...
            var filename = FileDialogInterface.OpenFilePanel("Open .enfl File", _previousDirectory, extensionFilters).FirstOrDefault();
        ...
        private void LoadButtonOnClick()
        {
            switch (_dataSource)
            {
                case DataSource.File:
                    ...
                    break;
                case DataSource.URL:
                    _filePlayer.LoadFromUrl(_filenameInputField.text);
                    break;
            }
        }
